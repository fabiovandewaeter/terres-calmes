...
class ZoneEffectTest {
    ...
    void explosionHitEntityInRadius() {
        ...
        attackEffects.add(new ZoneEffect(2f, damage));
    ...
    void explosionHitAllEntitiesInRadius() {
        ...
        // create entity
        Entity sourceEntity = new Entity(null, sourceEntityPos, 100, 2f);
        Entity targetEntity1 = new Entity(null, targetEntityPos1, 100, 2f, Entity.DEFAULT_SIZE, Entity.DEFAULT_SIZE,
                "Enemies");
        Entity targetEntity2 = new Entity(null, targetEntityPos2, 100, 2f, Entity.DEFAULT_SIZE, Entity.DEFAULT_SIZE,
                "Enemies");
        EntityManager entityManager = EntityManager.getInstance();
        entityManager.add(sourceEntity);
