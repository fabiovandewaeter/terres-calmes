...
public class IsometricCameraManager extends OrthographicCamera {

    private static IsometricCameraManager instance;
    ...
    private IsometricCameraManager() {
        super(DISPLAY_WIDTH, DISPLAY_HEIGHT);
    }

    public static IsometricCameraManager getInstance() {
        if (instance == null) {
            instance = new IsometricCameraManager();
        }
        return instance;
    }
    ...
    public void update() {
        ...
        if (player != null) {
            ...
            Vector2 playerDisplayPos = IsometricCameraManager.gameToDisplayCoordinates(player.getPosition());
